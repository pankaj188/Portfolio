...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Software Developer 🚀 having an experience of building Software and web applications with C++ , Java , JavaScript / Nodejs / React Native and some other cool libraries and frameworks."
  ),
  resumeLink:
...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡ Research and Development of new features, testing and bugs fixes"
    ),
    emoji("⚡ designing, developing, and delivering high-quality, scalable software"),
    emoji(
...
const educationInfo = {
  ...
  schools: [
    ...
    },
    {
      ...
      logo: require("./assets/images/marwarilogo.jpg"),
...
const workExperiences = {
  ...
  experience: [
    ...
    },
    {
      ...
      company: "Rapido",
      companylogo: require("./assets/images/rapido.jpg"),
      date: "Feb 2022 – Aprial 2022",
...
const podcastSection = {
  ...
  subtitle: "I LOVE TO TALK ABOUT PLACEMENT PREPARATION",

  // Please Provide with Your Podcast embeded Link
  podcast: [
    "https://www.youtube.com/playlist?list=PLy5yHlZym6M6t0H9M979G04W0qBauRaoY"
  ],
  display: true // Set false to hide this section, defaults to true
};
